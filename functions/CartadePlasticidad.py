...
# Con los datos del limite liquido y el Indice de plasticidad se grafica la ubicación del suelo en la carta de plasticidad.
    ...
    plt.hlines(7,15.7,29.5,'gray')
    plt.hlines(4,12.4,25.5,'gray')
    ...
    region_NOEXISTEIP = np.array([[0,0], [0,60], [75,60], [8,0]])
    ...
    path_NOEXISTEIP = mpath.Path(region_NOEXISTEIP)
    ...
    elif path_NOEXISTEIP.contains_point(point):
          print('NO EXISTE IP')
    else:
    ...
    plt.fill_between([29.5,15.7,12.4,25.5,29.5],[7,7,4,4,7], hatch='///', edgecolor='gray',facecolor='w', interpolate=True, alpha=1)
    l=[15.7,29.5,50,50]
    m=[7,7,22,38]
    plt.fill(l,m,'bisque')
